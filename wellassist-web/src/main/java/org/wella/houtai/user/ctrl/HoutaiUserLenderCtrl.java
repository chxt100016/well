...
@Controller
public class HoutaiUserLenderCtrl extends BaseController {
    @Autowired
    private UploadController uploadController;
    @Autowired
    private HoutaiUserSellerMapper sellerMapper;

    public HoutaiUserLenderCtrl() {
    }

    @RequestMapping({"/houtai/user/HoutaiUserLenderCtrl-getLenderList"})
    public String getLenderList(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "views/houtai/user/lender/lender_list.jsp";
    }

    @RequestMapping({"/houtai/user/HoutaiUserLenderCtrl-getLenderDetail"})
    public String getLenderDetail(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "views/houtai/user/lender/lender_detail.jsp";
    }

    @RequestMapping({"/houtai/user/HoutaiUserLenderCtrl-editLenderInfo"})
    public String editLenderInfo(HttpServletRequest request, HttpServletResponse response, Model model) {
        String userId = CommonUtil.GetRequestParam(request, "userId", "0");
        Map param;
        if(CommonUtil.getIntFromString(userId) > 0) {
        ...
        return "views/houtai/user/lender/lender_edit.jsp";
    }

    @RequestMapping(
            value = {"/houtai/user/HoutaiUserLenderCtrl-setLenderInfo"},
            method = {RequestMethod.POST}
    )
    public void setLenderInfo(HttpServletRequest request, HttpServletResponse response, Model model) {
        String ret = "-1";
        ...
        try {
            ...
            if(userId.equals("0")) {
                ...
                if(ret.equals("-1")) {
                    ...
                    mapClass.put("user_type", Integer.valueOf(2));
