...
@Controller
public class HoutaiUserSenderCtrl extends BaseController {
    @Autowired
    private UploadController uploadController;
    @Autowired
    private HoutaiUserSellerMapper sellerMapper;

    public HoutaiUserSenderCtrl() {
    }

    @RequestMapping({"/houtai/user/HoutaiUserSenderCtrl-getSenderList"})
    public String getSenderList(HttpServletRequest request, HttpServletResponse response, Model model) {
    ...
    @RequestMapping({"/houtai/user/HoutaiUserSenderCtrl-getSenderDetail"})
    public String getSenderDetail(HttpServletRequest request, HttpServletResponse response, Model model) {
    ...
    public String editSenderInfo(HttpServletRequest request, HttpServletResponse response, Model model) {
        String userId = CommonUtil.GetRequestParam(request, "userId", "0");
        Map param;
        if(CommonUtil.getIntFromString(userId) > 0) {
    ...
    @RequestMapping(
            value = {"/houtai/user/HoutaiUserSenderCtrl-setSenderInfo"},
            method = {RequestMethod.POST}
    )
    public void setSenderInfo(HttpServletRequest request, HttpServletResponse response, Model model) {
        String ret = "-1";
        ...
        try {
            ...
            if(userId.equals("0")) {
                ...
                if(ret.equals("-1")) {
                    ...
                    mapClass.put("user_type", Integer.valueOf(3));
