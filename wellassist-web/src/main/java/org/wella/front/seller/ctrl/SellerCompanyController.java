...
@Controller
public class SellerCompanyController extends BaseController {
    public SellerCompanyController() {
    }

    @RequestMapping({"front/seller/company/SellerCompanyController-companyInfo"})
    ...
    @RequestMapping({"front/seller/company/SellerCompanyController-changePass"})
    ...
    @RequestMapping({"front/seller/company/SellerCompanyController-updateNewPass"})
    ...
    @RequestMapping({"front/seller/company/SellerCompanyController-checkPayOrgPass"})
    ...
    @RequestMapping({"front/seller/company/SellerCompanyController-updatePayNewPass"})
