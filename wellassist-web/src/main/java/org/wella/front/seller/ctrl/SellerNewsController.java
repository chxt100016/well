...
@Controller
public class SellerNewsController extends BaseController {
    @Autowired
    private NewsMapper newsMapper;

    public SellerNewsController() {
    }

    @RequestMapping({"front/seller/SellerNewsController-xxList"})
    public String news_list(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "front/seller/news/xxList";
    }

    @RequestMapping(
            value = {"front/seller/SellerNewsController-setIsRead"},
    ...
    @RequestMapping(
            value = {"front/seller/SellerNewsController-delXx"},
            method = {RequestMethod.POST}
    )
