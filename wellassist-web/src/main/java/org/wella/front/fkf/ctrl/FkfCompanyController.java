...
@Controller
public class FkfCompanyController extends BaseController {
    public FkfCompanyController() {
    }

    @RequestMapping({"front/fkf/FkfCompanyController-companyInfo"})
    public String company_info(HttpServletRequest request, HttpServletResponse response, Model model) {
    ...
    @RequestMapping({"front/fkf/FkfCompanyController-companyInfoUpdate"})
    ...
    @RequestMapping({"front/fkf/FkfCompanyController-changePass"})
    public String change_password(HttpServletRequest request, HttpServletResponse response, Model model) {
        model.addAttribute("parentMenuNo", "4");
    ...
    @RequestMapping({"front/fkf/FkfCompanyController-updateNewPass"})
    ...
    @RequestMapping({"front/fkf/FkfCompanyController-checkPayOrgPass"})
    ...
    @RequestMapping({"front/fkf/FkfCompanyController-updatePayNewPass"})
