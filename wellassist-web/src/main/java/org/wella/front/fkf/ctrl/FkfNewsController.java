...
@Controller
public class FkfNewsController extends BaseController {
    @Autowired
    private NewsMapper newsMapper;

    public FkfNewsController() {
    }

    @RequestMapping({"front/fkf/FkfNewsController-xxList"})
    public String news_list(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "views/front/fkf/news/xxList.jsp";
    }

    @RequestMapping(
            value = {"front/fkf/FkfNewsController-setIsRead"},
    ...
    @RequestMapping(
            value = {"front/fkf/FkfNewsController-delXx"},
            method = {RequestMethod.POST}
    )
