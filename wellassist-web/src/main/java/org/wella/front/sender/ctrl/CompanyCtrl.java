...
public class CompanyCtrl extends BaseController {
    ...
    @RequestMapping({"/front/sender/CompanyCtrl-companyInfo"})
    public String companyInfo(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "/front/sender/company/companyInfo";
    }

    @RequestMapping({"/front/sender/CompanyCtrl-contactMode"})
    public String contactMode(HttpServletRequest request, HttpServletResponse response, Model model) {
        MyInfo myInfo = this.getMyInfo(request);
        model.addAttribute("parentMenuNo", "4");
        ...
        model.addAttribute("provinceList", this.getChildRegionList(0));
        model.addAttribute("myInfo", myInfo);
        return "/front/sender/company/contactMode";
    }

    @RequestMapping({"front/sender/CompanyController-contactModeUpdate"})
    ...
    @RequestMapping({"front/sender/CompanyController-companyInfoUpdate"})
    ...
    @RequestMapping({"/front/sender/CompanyCtrl-changePass"})
    public String changePass(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        MyInfo myInfo = this.getMyInfo(request);
        model.addAttribute("userName", myInfo.getUserName());
        return "/front/sender/company/changePass";
    }

    @RequestMapping({"/front/sender/CompanyCtrl-checkOrgPass"})
    ...
    @RequestMapping({"/front/sender/CompanyCtrl-updateNewPass"})
    ...
    @RequestMapping({"/front/sender/CompanyCtrl-checkPayOrgPass"})
    ...
    @RequestMapping({"/front/sender/CompanyCtrl-updatePayNewPass"})
