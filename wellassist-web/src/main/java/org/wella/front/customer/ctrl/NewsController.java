...
public class NewsController extends BaseController {
    ...
    @RequestMapping({"front/customer/NewsController-xxList"})
    public String news_list(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        return "front/customer/news/xxList";
    }

    @RequestMapping(
            value = {"front/customer/NewsController-setIsRead"},
    ...
    @RequestMapping(
            value = {"front/customer/NewsController-delXx"},
            method = {RequestMethod.POST}
    )
