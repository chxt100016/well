		...
		<div style="padding-top:100px;">
			<div style="padding-left:455px;padding-top:210px;padding-bottom:105px;background:url('${pageContext.request.contextPath}/resources/wella/front/images/backobj01.png') no-repeat;">
				<div class="whiteframe" style="background:white;border:solid 1px #c0c0c0;width:400px;height:430px;font-size:24px;">
					<form id="loginForm" name="loginForm" method="post" action="${pageContext.request.contextPath}/front/sender/SenderLoginController-loginNext">
						...
						<div style="padding-top:26px;padding-left:52px;padding-right:46px;">
							<span style="float:left; font-size: 18px;"><a href="${pageContext.request.contextPath}/front/customer/CustomerLoginCtrl-getPass?userType=3">忘记密码</a></span>
							<span style="float:right; font-size: 18px;"><a href="${pageContext.request.contextPath}/front/sender/SenderLoginController-register">注册</a></span>
						</div>
...
<script type="text/javascript">
	$("#login").click( function(){
		var vehicleTrans = '${vehicleTrans}';
		if(vehicleTrans == undefined || vehicleTrans == '' ){
			vehicleTrans = '0';
		}
		$.post($("#loginForm").attr("action"),$("#loginForm").serialize(),function(data){
			data = $.parseJSON(data);
	        if(data.status=="1"){
	        	if(vehicleTrans != '0'){ // 抢单页面
	        		window.location.href = "${pageContext.request.contextPath}/front/sender/FrontSenderOrderCtrl-qdPage?vehicleTrans="+vehicleTrans;
	        	}else{
	        		window.location.href = "${pageContext.request.contextPath}/front/sender/SenderHomeController-home";	
	        	}
