			...
			<div align=left style="width:1000px;height:100%;">
				...
				<div style="display:flex;">
					...
					<div style="float:left;width:250px;height:200px;">
						<div id="lijigoumai" class="redbutton" style="margin-left: 86px;margin-top: 16px;padding: 12px;font-size: 24px; <c:if test = "${userInfo.userState != 1}">display:none;</c:if>">立即购买</div>
					</div>
				</div>
						...
						<tr>
							<td style="padding:8px;">
 								<div style="background: white;display: inherit;box-shadow: 3px 3px 3px #c0c0c0;padding:4px;">
									<div>
										<a href="<c:url value="/qt/customer/chanpinxiangqing"/>">
...
<script type="text/javascript">
	$("#lijigoumai").click( function(){
		window.location.href="<c:url value="/front/customer/CustomerHomeCtrl-makeOrder?id=kunlun_ware"/>";
	});
