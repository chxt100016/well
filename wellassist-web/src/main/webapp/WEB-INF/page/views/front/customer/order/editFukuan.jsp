	...
	<div id="ddfkDiv" align="center">
		<div style="width:1000px;">
			<div style="border-bottom: solid 1px #e0e0e0; width: 1000px;padding-bottom:12px;margin-top:20px;margin-bottom: 24px;">
				...
				<div style="text-align:center;font-size:24px;">支付</div>
			</div>
		</div>
	...
	$("#ddfkForm").validate({
	    ...
	    submitHandler: function(form){
	    	...
	    	if(zfMethod != "1"){
	    		...
	    		var url = "${pageContext.request.contextPath}/front/seller/SellerFinanceController-checkWorkPass?pass="+pass+"&userId=${userId}";
