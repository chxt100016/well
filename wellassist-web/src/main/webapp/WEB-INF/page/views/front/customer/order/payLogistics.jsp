            ...
            <div class="ui container pd-10 pd-lf-30">
                ...
                <table class="ui table">
                    <tr>
                        ...
                        <td>公司名称 ${logisticsInfo.sellerUserName}</td>
                    </tr>
...
<script>
    ...
    const url2="${pageContext.request.contextPath}/customer/payLogistics";
    const payMoney=${logisticsInfo.grabMoney};
    const loanLeft=${logisticsInfo.userCreditMoney};
    const banlanceLeft= ${logisticsInfo.userMoney};
            ...
            onSuccess: function(e) {
               ...
               function GetJsonData() {
                    var json = {
                        ...
                        'logisticsInfoId':${logisticsInfo.logisticsId},
                        'grabMoney':${logisticsInfo.grabMoney},
