...
<head>
    ...
    <title>WellAssist供应链系统(物流端)</title>
	...
	<style>
		...
		.row-fld{width: 230px; background-color: white;font-size: 13px;  overflow: auto; float: left; box-shadow: 3px 4px 9px 1px #BDBDBD; margin-top:20px; margin-right:20px;}
	</style>
</head>
		...
		<div class="abovenavbar">
			<div align=center>
				 <div style="width:1000px;">
					...
					<span style="float: right;"><a href="<c:url value="/front/sender/SenderHomeController-main"/>">管理员</a></span>
				</div>
		     </div>
         </div>
...
<script>
	$('.gologin').click(function() {
		var regUrl = "";
		regUrl = "${pageContext.request.contextPath}/front/sender/SenderLoginController-login";
		window.location.href = regUrl;
	});
	
	$("#username").change( function(){
		if($("#username").val()== "logout"){
			var regUrl = "";
			
			regUrl = "${pageContext.request.contextPath}/front/SenderHomeController-home";
