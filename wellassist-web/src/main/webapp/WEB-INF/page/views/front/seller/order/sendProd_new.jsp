                ...
                <table class="ui  celled  table">
                    ...
                    <tbody >
                        <tr v-for="(vehicle,index) in Vehicles" v-cloak>
                            ...
                            <td>{{vehicle.vehicleHangingNo}} </td>
                            <td>
                                <input  class="vh" placeholder=" "  id="vehicleSize"  v-model="vehicle.vehicleActualSize" type="number" v-on:change="validedTex($event.target.value,vehicle.vehicleSize,index)"><span> 容量：<span >{{vehicle.vehicleSize}}</span> 顿</span></td>
                            <td>
...
<script>
    ...
    var vm= new Vue({
        ...
        methods:{
            ...
            validedTex:function(tex,size,i){
                      var Tex= tex;
                        ...
                        // var c= this.vehicle.vehicleSize;
                        console.log(size); 
                        var r = /^\+?[1-9][0-9]*$/ ;
                        ...
                        vm.Vehicles[i].vehicleActualSize=size
                        return tex=size
                        }
                        if(Tex>=size){
                            console.log("太大了s！");
