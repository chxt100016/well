...
<body>
    ...
    <!-- parentMenu==5 -->
        <div class="item ">
            <a class="  title font-white  <c:if test = "${parentMenuNo == '1' }"> active</c:if>">
   ...
   <!-- parentMenu==1 -->
        <div class="item">
            <a class="title <c:if test = "${parentMenuNo == '5' }"> active</c:if>">
            <i class="dropdown icon"></i>
            订单中心
            </a>
          <div class="content <c:if test = "${parentMenuNo == '5' }"> active</c:if>">
                <div class="accordion transition visible" style="display: block !important;margin-top:0px">
                    ...
                    <div onclick="window.location.href='${pageContext.request.contextPath}/seller/order'" class="content pd-10 pointer  font-grey  <c:if test = "${parentMenuNo == '5' }"> font-white</c:if> ">
                       <span >订单列表</span>
					</div>
        ...
        <div class="item">
          ...
          <div class="content <c:if test = "${parentMenuNo == '2' }"> active</c:if>">
                <div class="accordion transition visible" style="display: block !important;margin-top:0px">
                    ...
                    <div onclick="window.location.href='${pageContext.request.contextPath}/seller/accountInfo'" class="content pd-10 pointer  font-grey  <c:if test = "${parentMenuNo == '2'&&childMenuNo  == '1' }"> font-white</c:if> ">
                       <span > 账户信息</span>
                    </div>     
                    <div onclick="window.location.href='${pageContext.request.contextPath}/seller/withdrawRecordList'" class="content pd-10 pointer  font-grey  <c:if test = "${parentMenuNo == '2'&&childMenuNo == '6' }"> font-white</c:if> ">
                       提现记录
                    </div>
                    <div  onclick="window.location.href='${pageContext.request.contextPath}/seller/rechargeRecord'" class="content pd-10 pointer  font-grey  <c:if test = "${parentMenuNo == '2'&&childMenuNo  == '5' }"> font-white</c:if> ">
                       充值记录
                    </div>                  
                </div>
            </div>
        ...
        <div class="item">
          ...
          <div class="content <c:if test = "${parentMenuNo == '4'}"> active</c:if>">
                <div class="accordion transition visible" style="display: block !important;margin-top:0px">
                    ...
                    <div onclick="window.location.href='${pageContext.request.contextPath}/seller/bankcardPage'"  class="content pd-10 pointer  font-grey  <c:if test = "${parentMenuNo == '4'&&childMenuNo  == '4' }"> font-white</c:if> ">
                       <span > 银行卡管理</span>
                    </div>
                    <div onclick="window.location.href='${pageContext.request.contextPath}/seller/reportManagement'"  class="content pd-10 pointer  font-grey  <c:if test = "${parentMenuNo == '4'&&childMenuNo  == '5' }"> font-white</c:if> ">
                        <span > 报表管理</span>
                    </div>
                </div>
            </div>
