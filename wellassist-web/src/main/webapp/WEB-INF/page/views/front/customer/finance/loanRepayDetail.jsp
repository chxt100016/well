             ...
             <div class="ui divider"></div>
                <div class="ui equal width grid">
                    ...
                    <div class="column">还款状态:
                         ...
                         <span  v-if='loan.loan_state==3'><i class="check circle outline icon greenxx" style="font-size:16px"></i> 已还清 </span>
                    </div>
                    <div class="column">借款时间：{{loan.loan_date}} </div>
                </div>
                <div class="ui equal width grid">
                    <div class="column">借款金额：<span class="ft-wt-bd ft-sz-16"> {{loan.loan_money}}</span>元</div>
                    <div class="column">产生利息：{{loan.repay_lixi}}元</div>
                 ...
                 <div class="ui equal width grid">
                    ...
                    <div class="column">已还利息：{{loan.lixi_money}}元</div>
