...
<script type="text/javascript">
	...
	$("#frm_pay_pass").validate({
	    ...
	    submitHandler: function(form){
	    	...
	    	$.post("${pageContext.request.contextPath}/front/fkf/FkfCompanyController-checkPayOrgPass", {oldPass:oldPass},	function(data) {
				if(data.state == 1) {
					var act_url = "${pageContext.request.contextPath}/front/fkf/FkfCompanyController-updatePayNewPass";
			    	$.post(act_url,$(form).serialize(),function(data){
			    		data = $.parseJSON(data);
			    		if(data.state==1){
			            	alert("保存成功!");
