...
<body style="margin:0; padding:0; background-color:#f5f5f5;">
	<div class="main-wrapper" style="margin-left: 0px; margin-top:30px;">
		...
		<div align=center style="padding-top:12px;">
			<div align=left style="width:1000px;">
				<div style="border-bottom: solid 1px #e0e0e0; width: 1000px;padding-bottom:12px;margin-top:20px;margin-bottom: 24px;">
					<div style="text-align:center;font-size: 18px; font-weight: 600;">抢单成功</div>
				</div>
			</div>
			...
			<div align=center style="width:1000px; background: white;box-shadow: 2px 2px 8px #808080;padding-bottom:16px;">
				...
				<div style="font-size:24px;margin-bottom: 48px;">抢单成功, 等待卖家确认抢单</div>
				<div id="backtodingdanlist" style="font-weight:bold;font-size:16px;margin-bottom: 56px;color:#0077dd;cursor:pointer;">返回抢单列表</div>
			</div>
		</div>
