		...
		<div class="box box-solid">
        	<div class="box-header with-border">
            	<i class="fa fa-text-width"></i>
             	<h3 class="box-title">买家信息<c:if test="${userId==0}"></c:if>添加<c:if test="${userId!=0}">编辑</c:if></h3>
           	</div>
           	<div class="box-body">
           		<form id="buyerEditForm" name="buyerEditForm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/houtai/user/HoutaiUserBuyerCtrl-setBuyerInfo">
...
<script type="text/javascript">
 	...
 	function uploadImage(idx){
 		...
 		$("#buyerEditForm").ajaxSubmit(options);
