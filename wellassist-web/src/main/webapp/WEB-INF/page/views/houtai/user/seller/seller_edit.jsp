		...
		<div class="box box-solid">
        	<div class="box-header with-border">
            	<i class="fa fa-text-width"></i>
             	<h3 class="box-title">卖家信息<c:if test="${userId==0}"></c:if>添加<c:if test="${userId!=0}">编辑</c:if></h3>
           	</div>
           	<div class="box-body">
           		<form id="sellerEditForm" name="sellerEditForm" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/houtai/user/HoutaiUserSellerCtrl-setSellerInfo">
...
<script type="text/javascript">
 	...
 	function uploadImage(idx){
 		...
 		$("#sellerEditForm").ajaxSubmit(options);
