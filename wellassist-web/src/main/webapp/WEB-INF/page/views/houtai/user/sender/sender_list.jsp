		...
		<div class = "row">
            ...
            <div class = "col-sm-12">	
	            <div class="dataTables_filter">
	            	<form id="searchFrm" method="post" action="${pageContext.request.contextPath}/houtai/user/HoutaiUserSenderCtrl-getSenderList">	
	            		<label>
	            			物流名称 : <input name="userName"  value="${param.userName}" class="form-control input-sm houtai-search-control" placeholder="物流名称" />
	            			&nbsp;&nbsp;
...
<script type="text/javascript">
 	$(function(){
 		...
 		$("#btn_add").click(function(){
 			window.location.href = "${pageContext.request.contextPath}/houtai/user/HoutaiUserSenderCtrl-editSenderInfo";
 		});
 	});
 	
 	function getUserDetail(userId){
 		window.location.href = "${pageContext.request.contextPath}/houtai/user/HoutaiUserSenderCtrl-getSenderDetail?userId=" + userId;
 	}
</script>
