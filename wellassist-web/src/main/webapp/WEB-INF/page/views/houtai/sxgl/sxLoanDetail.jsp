                    			...
                    			<tbody>
                    				<c:forEach var="item" items="${list}" varStatus="status">
                    					<tr>
											...
											<td width="20%">${item.loanMoney}</td>
											<td width="20%">${item.loanLixiMoney}</td>
											<td width="20%"><fmt:formatDate value="${item.loanDate}" pattern="yyyy年MM月dd日  HH:mm:ss"/></td>
											<td width="25%">${item.loanIp}</td>
										</tr>
                    				</c:forEach>
