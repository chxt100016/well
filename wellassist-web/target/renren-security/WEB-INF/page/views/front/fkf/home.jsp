	...
	<div class="main-wrapper" style="margin-left: 0px;">
		...
		<div class="abovenavbar">
			<div align=center>
				<div style="width:1000px;">
					...
					<span style="float: right;"><a href="<c:url value="/front/fkf/FkfHomeCtrl-main"/>">管理员</a></span>
				</div>
			</div>
		</div>
		...
		<div align=center style="padding-top:12px;">
			<div align=left style="width:1000px;height:100%;">
				...
				<div class="start_heading2">${userName}</div>
...
<script type="text/javascript">
	...
	$("#logout").click( function(){
		window.location.href="<c:url value="/front/fkf/FkfLoginCtrl-logout"/>";
	});
</script>
</html>