...
<div id= "content-rect">
	...
	<c:forEach var = "item" items = "${list}">
		<div style="height:120px; font-size:14px;">
			...
			<div class = "row_fld" style = "width:25%;">
				<div style="text-align:center;padding-top:20px;">授信金额:&nbsp;&nbsp;${item.creditSjMoney}元</div>
				<div style="text-align:center;padding-top:20px;">剩余金额:&nbsp;&nbsp;${item.remainHkMoney}元</div>
				<div style="text-align:center;padding-top:20px;">已还金额:&nbsp;&nbsp;${item.retHkMoney}元</div>
			</div>
			<div class = "row_fld" style = "width:25%;">
				<div style="text-align:center;padding-top:20px;">${item.remainLxMoney}元</div>
			</div>
		</div>
	</c:forEach>
