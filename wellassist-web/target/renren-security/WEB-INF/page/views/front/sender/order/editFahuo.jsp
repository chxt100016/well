...
<script type="text/javascript">
	...
	$("#pubbtn").click(function(){
		...
		if(confirm("你要确定操作吗?")){
			$.post("${pageContext.request.contextPath}/front/sender/FrontSenderOrderCtrl-setFahuo",{vehicleTrans:vehicleTrans,cfDate:cfDate,ddDate:ddDate,orderData:orderData},function(data){
				data = $.parseJSON(data);
	    		alert(data.content);
	            if(data.status=="1"){
	            	window.location.href = "${pageContext.request.contextPath}/front/sender/FrontSenderOrderCtrl-orderList";
	            }
	      	})
	      	.error(function(data){
	      	});
