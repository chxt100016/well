	...
	<div class="col-xs-12">
		<div class = "row">
			<div class="box-header">
                  <h3 class="box-title">放款家列表</h3>
            </div>
            <div class = "col-sm-12">	
	            <div class="dataTables_filter">
	            	<form id="searchFrm" method="post" action="${pageContext.request.contextPath}/houtai/user/HoutaiUserLenderCtrl-getLenderList">	
	            		<label>
	            			放款家名称 : <input name="userName"  value="${param.userName}" class="form-control input-sm houtai-search-control" placeholder="放款家名称" />
	            			&nbsp;&nbsp;
...
<script type="text/javascript">
 	$(function(){
 		...
 		$("#btn_add").click(function(){
 			window.location.href = "${pageContext.request.contextPath}/houtai/user/HoutaiUserLenderCtrl-editLenderInfo";
 		});
 	});
 	
 	function getUserDetail(userId){
 		window.location.href = "${pageContext.request.contextPath}/houtai/user/HoutaiUserLenderCtrl-getLenderDetail?userId=" + userId;
 	}
</script>
