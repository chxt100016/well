		...
		<div class="tabbable tabbable-custom boxless">
			<c:if test="${userType==1}">
				<ul class="nav nav-tabs">
					<li class="active"><a href="javascript:void(0)" data-toggle="tab" tabId="1">未审核</a></li>
					<li class=""><a href="javascript:void(0)" data-toggle="tab" tabId="2">审核中(审核人)</a></li>
					<li class=""><a href="javascript:void(0)" data-toggle="tab" tabId="3">审核中(供货方)</a></li>
					<li class=""><a href="javascript:void(0)" data-toggle="tab" tabId="4">已审核</a></li>
...
<script type="text/javascript">
    ...
    function onSetStatus(idx,state){
		...
		$.post("${pageContext.request.contextPath}/ht/Common/showDialog",{dlgType : 1}, function(data) {			
            $("#dialog-area").html(data);
			openStatusDialog("审核",state,"",
				function(state,content,shenheren){
					$.post("${pageContext.request.contextPath}/ht/Enterprise/UserCtrl-setStatus",{subIdx: 0,selIdx: idx,state: state,reason: content, shenheren : shenheren}, function(data) {
						onSearch();
					});
				}
			);
